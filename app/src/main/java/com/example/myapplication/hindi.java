...
import com.example.myapplication.database.Database3;
import com.mancj.materialsearchbar.MaterialSearchBar;

import java.util.ArrayList;
import java.util.List;

public class hindi extends AppCompatActivity implements searchAdapter.OnNoteListener  {
...
//default set all result
    ...
    public void onNoteClick(int position) {
        ...
        Intent intent=new Intent(hindi.this,content.class);
